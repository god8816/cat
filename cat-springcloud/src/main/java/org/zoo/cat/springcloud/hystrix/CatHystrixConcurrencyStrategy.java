...
/**
 * CatHystrixConcurrencyStrategy.
 *
 * @author dzc
 */
public class CatHystrixConcurrencyStrategy extends HystrixConcurrencyStrategy {

    private static final Logger LOGGER = LoggerFactory.getLogger(CatHystrixConcurrencyStrategy.class);
    ...
    public <T> Callable<T> wrapCallable(Callable<T> callable) {
        final CatTransactionContext catTransactionContext =
                CatTransactionContextLocal.getInstance().get();
        return () -> {
            CatTransactionContextLocal.getInstance().set(catTransactionContext);
