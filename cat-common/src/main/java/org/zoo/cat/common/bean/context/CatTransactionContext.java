...
package org.zoo.cat.common.bean.context;
 ...
 */
@Data
public class CatTransactionContext implements Serializable {
    ...
    /**
     * this cat action. {@linkplain CatActionEnum}
     */
    private int action;

    /**
     * 事务参与的角色. {@linkplain CatRoleEnum}
     */
    private int role;
