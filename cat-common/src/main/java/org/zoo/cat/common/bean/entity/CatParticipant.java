...
public class CatParticipant implements Serializable {
    ...
    private CatInvocation confirmCatInvocation;

    private CatInvocation cancelCatInvocation;
    
    private CatInvocation noticeCatInvocation;

    public CatParticipant(final String transId,
                            final CatInvocation confirmCatInvocation,
                            final CatInvocation cancelCatInvocation) {
    ...
    public CatParticipant(final String transId,
		            final CatInvocation noticeCatInvocation) {
		this.transId = transId;
