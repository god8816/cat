...
package org.zoo.cat.core.interceptor;
...
public abstract class AbstractCatTransactionAspect {
    ...
    private CatTransactionInterceptor catTransactionInterceptor;
     ...
     */
    protected void setCatTransactionInterceptor(final CatTransactionInterceptor catTransactionInterceptor) {
