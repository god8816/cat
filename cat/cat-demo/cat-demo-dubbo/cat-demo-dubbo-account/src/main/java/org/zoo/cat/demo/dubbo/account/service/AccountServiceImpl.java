...
import org.zoo.cat.demo.dubbo.account.mapper.AccountMapper;
...
public class AccountServiceImpl implements AccountService {
    ...
    @Override
    @Cat(pattern = TransTypeEnum.TCC,confirmMethod = "confirm", cancelMethod = "cancel")
    ...
    @Override
    @Cat(pattern = TransTypeEnum.TCC,confirmMethod = "confirmNested", cancelMethod = "cancelNested")
