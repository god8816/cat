...
package org.zoo.cat.demo.dubbo.order.controller;
...
import org.zoo.cat.demo.dubbo.order.service.OrderService;
...
public class OrderController {
    ...
    @PostMapping(value = "/createOrderTimeOut")
    @ApiOperation(value = "创建订单（注意：当订单创建超时异常，此时触发循环补偿）")
    public String createOrderTimeOut(@RequestParam(value = "orderId") Integer orderId) {
        return orderService.createOrderTimeOut(orderId);
    }
    
    @PostMapping(value = "/createOrderException")
    @ApiOperation(value = "创建订单（注意：当订单创建异常，此时触发循环补偿）")
    public String createOrderException(@RequestParam(value = "orderId") Integer orderId) {
        return orderService.createOrderException(orderId);
    }
