...
import org.zoo.cat.admin.interceptor.AuthInterceptor;
import org.zoo.cat.admin.service.CompensationService;
import org.zoo.cat.admin.service.compensate.FileCompensationServiceImpl;
import org.zoo.cat.admin.service.compensate.JdbcCompensationServiceImpl;
import org.zoo.cat.admin.service.compensate.MongoCompensationServiceImpl;
import org.zoo.cat.admin.service.compensate.RedisCompensationServiceImpl;
import org.zoo.cat.admin.service.compensate.ZookeeperCompensationServiceImpl;
 ...
 */
@Configuration
public class CatAdminConfiguration {
    ...
    static class MongoRecoverConfiguration {
        ...
        public CompensationService mongoTransactionRecoverService() {
            ...
            final String userName = env.getProperty("compensation.mongo.userName", "dzc");
